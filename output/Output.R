...
png("output/qualitycare_barplot.png", width = 475, height = 546)
...
png("output/age_histogram.png", width = 475, height = 546)
...
png("output/bmi_histogram.png", width = 475, height = 546)
